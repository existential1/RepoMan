...
DEFAULTURL = "https://docs.google.com/forms/d/1emhA5uhsgx2lWJYk2o_jnSnG88_weQ_TV9aAA7M2t6Q/viewform"
  ...
  def test_required_1stcb #only fill/select name and first checkbox
    #find and set name field
    @driver.find_element(:id, "entry_1041466219").send_keys("S")
  ...
  def test_required_2ndcb #only fill/select name and second checkbox
    #find and set name field
    @driver.find_element(:id, "entry_1041466219").send_keys("Spartacus 1 $")
  ...
  def test_bothcheckboxes #fill/select name and both checkboxes
    #find and set name field
    @driver.find_element(:id, "entry_1041466219").send_keys("-- @@ &&")
    #find and set first checkbox
    @driver.find_element(:id, "group_310473641_1").click
    #find and set second checkbox
    @driver.find_element(:id, "group_310473641_2").click
  ...
  def test_required_whitespace_name #only fill/select name and first checkbox
    #find and set name field
    @driver.find_element(:id, "entry_1041466219").send_keys("  ")
    #find and set first checkbox
    @driver.find_element(:id, "group_310473641_1").click
